...
local function getObjGen()
    ...
    local function getObjects()
        local function initObj()
            ...
            Gui.Selection.BackgroundColor3 = Color3.fromRGB(209, 92, 19)
            ...
            Gui.Select.ImageColor3 = Color3.fromRGB(209, 92, 19)
            ...
            Gui.Select_2.ImageColor3 = Color3.fromRGB(209, 92, 19)
            ...
            Gui.Select_3.ImageColor3 = Color3.fromRGB(209, 92, 19)
            ...
            Gui.Logo.ImageColor3 = Color3.fromRGB(209, 92, 19)
...
function UILibrary.Window:ChangeCategory(new)
    ...
    if Object and self.currentSelection ~= Object then
        ...
        TweenService:Create(
            ...
            TI,
            {
                ImageColor3 = Color3.fromRGB(209, 92, 19)
            }
        ):Play()
        ...
        TweenService:Create(
            ...
            TI,
            {
                TextColor3 = Color3.fromRGB(209, 92, 19)
            }
        ):Play()
    ...
    functions.setValue = function(new)
        ...
        if new then
            ...
            TweenService:Create(
                ...
                TI,
                {
                    BackgroundColor3 = Color3.fromRGB(240, 149, 206)
                }
            ):Play()
        else
            TweenService:Create(

...
local function getObjGen()
    ...
    local function getObjects()
        local function initObj()
            ...
            Gui.Selection.BackgroundColor3 = Color3.fromRGB(173, 21, 21)
            ...
            Gui.Select.ImageColor3 = Color3.fromRGB(173, 21, 21)
            ...
            Gui.Select_2.ImageColor3 = Color3.fromRGB(173, 21, 21)
            ...
            Gui.Select_3.ImageColor3 = Color3.fromRGB(173, 21, 21)
            ...
            Gui.Logo.ImageColor3 = Color3.fromRGB(173, 21, 21)
...
function UILibrary.Window:ChangeCategory(new)
    ...
    if Object and self.currentSelection ~= Object then
        ...
        TweenService:Create(
            ...
            TI,
            {
                ImageColor3 = Color3.fromRGB(173, 21, 21)
            }
        ):Play()
        ...
        TweenService:Create(
            ...
            TI,
            {
                TextColor3 = Color3.fromRGB(173, 21, 21)
            }
        ):Play()
